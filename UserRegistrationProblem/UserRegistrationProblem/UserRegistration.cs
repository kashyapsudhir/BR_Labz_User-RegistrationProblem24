...
namespace UserRegistrationProblem
{
    class UserRegistration
    {
        ...
        {
            bool emailForEntry1 = userRegistrationRegex.validatEmail(email1);
            bool emailForEntry2 = userRegistrationRegex.validatEmail(email2);
            bool emailForEntry3 = userRegistrationRegex.validatEmail(email3);
            bool emailForEntry4 = userRegistrationRegex.validatEmail(email4);
        ...
        {
            if (userRegistrationRegex.validatEmail(email))
            {
